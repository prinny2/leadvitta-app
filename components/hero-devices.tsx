    ...
    <div style={{
      ...
      <div style={{ padding: "4px 4px 10px", borderBottom: "1px solid rgba(201,160,96,0.12)", marginBottom: "6px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
          ...
          <div style={{ fontSize: "5.5px", fontWeight: 700, color: C.champ, lineHeight: 1 }}>
            Lead<span style={{ color: C.gold }}>Bellus</span>
          </div>
        </div>
      </div>
      ...
      {items.map((item, i) => (
        <div key={item.label} style={{
          ...
          <div style={{
            ...
            background: i === activeIdx ? C.gold : "rgba(255,255,255,0.18)",
          }}/>
          <span style={{
            fontSize: "4.5px", flex: 1, overflow: "hidden", whiteSpace: "nowrap",
            color: i === activeIdx ? C.gold : "rgba(255,255,255,0.4)",
            fontWeight: i === activeIdx ? 700 : 400,
          }}>{item.label}</span>
          {item.pro && (
            <span style={{ fontSize: "3px", background: "rgba(201,160,96,0.15)", border: "1px solid rgba(201,160,96,0.3)", color: C.gold, borderRadius: "9999px", padding: "0 2px", lineHeight: "7px", flexShrink: 0 }}>PRO</span>
          )}
        </div>
      ))}
    ...
    <div style={{ display: "flex", height: "100%" }}>
      ...
      <div style={{ flex: 1, background: C.bg, padding: "10px 10px 8px", display: "flex", flexDirection: "column", gap: "6px", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
          ...
          <div style={{ background: C.gold, borderRadius: "6px", padding: "4px 8px", fontSize: "5px", fontWeight: 700, color: C.bg, display: "flex", alignItems: "center", gap: "3px" }}>
            ✦ Gerar resposta
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "5px" }}>
          {[
            ...
            <div key={k.label} style={{
              ...
              border: k.gold ? "1px solid rgba(201,160,96,0.4)" : `1px solid ${C.border}`,
              boxShadow: k.gold ? "0 0 10px rgba(201,160,96,0.1)" : undefined,
            }}>
        ...
        <div style={{
          ...
          boxShadow: "0 0 30px rgba(201,160,96,0.05)",
        }}>
          ...
          <div style={{
            ...
            border: "1px solid rgba(201,160,96,0.3)",
            boxShadow: "0 0 12px rgba(201,160,96,0.2)",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "5px", flex: 1, minHeight: 0 }}>
          ...
          <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: "6px", padding: "7px", display: "flex", flexDirection: "column" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "5px" }}>
              <div>
                <div style={{ fontSize: "4px", color: C.muted, textTransform: "uppercase", letterSpacing: "0.06em" }}>Esta semana</div>
            ...
            <svg width="100%" height="100%" viewBox={`0 0 ${W+12} ${H}`} preserveAspectRatio="none" style={{ flex: 1, minHeight: "50px" }}>
              <defs>
                <linearGradient id="hd2-area" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#C9A060" stopOpacity="0.35"/>
                  <stop offset="100%" stopColor="#C9A060" stopOpacity="0"/>
                </linearGradient>
              </defs>
              {[H*0.25, H*0.5, H*0.75].map(y => (
                <line key={y} x1="0" y1={y} x2={W+12} y2={y} stroke="rgba(255,255,255,0.04)" strokeWidth="0.5"/>
              ))}
              <path d={areaPath} fill="url(#hd2-area)"/>
              ...
              {DIAS.map((d, i) => (
                <text key={d} x={xs[i]} y={H} textAnchor="middle" fill={C.muted} fontSize="4">{d}</text>
              ))}
            </svg>
          </div>
          ...
          <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: "6px", padding: "7px", display: "flex", flexDirection: "column" }}>
            ...
            <svg width="100%" height="50" viewBox="0 0 60 60" style={{ display: "block" }}>
              ...
              <circle cx="30" cy="30" r="22" fill="none" stroke="#F97316" strokeWidth="8"
                strokeDasharray={`${0.14*138.2} ${138.2}`} strokeDashoffset="0" transform="rotate(-90 30 30)"/>
              <circle cx="30" cy="30" r="22" fill="none" stroke="#C9A060" strokeWidth="8"
                strokeDasharray={`${0.32*138.2} ${138.2}`} strokeDashoffset={`${-0.14*138.2}`} transform="rotate(-90 30 30)"/>
              <circle cx="30" cy="30" r="22" fill="none" stroke="#6B8CAE" strokeWidth="8"
                strokeDasharray={`${0.54*138.2} ${138.2}`} strokeDashoffset={`${-0.46*138.2}`} transform="rotate(-90 30 30)"/>
...
function ScreenGerador() {
  const responses = [
    { label: "Suave",      emoji: "🌸", color: C.blue,
      text: "Oi! Que bom que você nos encontrou ✨ O botox é muito seguro e os resultados são incríveis. Posso te explicar melhor?" },
    { label: "Consultiva", emoji: "💎", color: C.gold,
      text: "Olá! Adorei o contato. Antes de falar em investimento, me conta: você busca mais prevenção ou já tem alguma linha que te incomoda?" },
    { label: "Fechamento", emoji: "🎯", color: C.green,
      text: "Perfeita escolha! Tenho horário esta semana. O que funciona melhor pra você — manhã ou tarde?" },
  ];
  return (
    <div style={{ display: "flex", height: "100%" }}>
      ...
      <div style={{ flex: 1, background: C.bg, padding: "10px", display: "flex", flexDirection: "column", gap: "6px", overflow: "hidden" }}>
        ...
        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: "6px", padding: "7px" }}>
          ...
          <div style={{
            background: C.bg, border: "1px solid rgba(201,160,96,0.35)", borderRadius: "5px",
            padding: "5px 6px", fontSize: "5px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7,
          }}>
            Olá! Quanto custa o botox? Vi no Instagram e fiquei curiosa ✨
          </div>
          <div style={{ display: "flex", gap: "5px", marginTop: "5px" }}>
            <div style={{ flex: 1, background: C.bg, border: `1px solid ${C.border}`, borderRadius: "4px", padding: "3px 6px", fontSize: "4px", color: C.muted }}>
              Tom: Consultivo · Situação: Interesse
            </div>
        ...
        {responses.map((r) => (
          <div key={r.label} style={{
            ...
            borderRadius: "5px", padding: "6px 7px", flex: 1,
          }}>
    ...
    <div style={{ display: "flex", height: "100%" }}>
      ...
      <div style={{ flex: 1, background: C.bg, padding: "10px", display: "flex", flexDirection: "column", gap: "6px", overflow: "hidden" }}>
        ...
        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: "6px", padding: "6px" }}>
          <div style={{ fontSize: "4.5px", color: "rgba(255,255,255,0.65)", lineHeight: 1.7, marginBottom: "4px" }}>
    ...
    <div style={{ display: "flex", height: "100%" }}>
      ...
      <div style={{ flex: 1, background: C.bg, padding: "10px", display: "flex", flexDirection: "column", gap: "6px", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
          ...
          <div style={{ background: "rgba(201,160,96,0.1)", border: "1px solid rgba(201,160,96,0.2)", borderRadius: "6px", padding: "3px 6px", fontSize: "4px", color: C.gold }}>
            🖱️ Passe o mouse
          </div>
        </div>
        ...
        <div style={{
          ...
          boxShadow: "inset 0 0 80px rgba(0,0,0,0.7), inset 0 40px 60px rgba(0,0,0,0.4)",
          border: "1.5px solid #2a1c0a",
          padding: "36px 18px 0",
          position: "relative",
        }}>
          {/* Warm ceiling glow */}
          <div style={{
            position: "absolute", top: 0, left: "15%", right: "15%", height: "90px",
            background: "radial-gradient(ellipse at 50% 0%, rgba(201,160,96,0.18) 0%, rgba(180,120,40,0.05) 60%, transparent 100%)",
            pointerEvents: "none",
          }}/>
          ...
          <div style={{
            ...
            backgroundImage: "repeating-linear-gradient(90deg,rgba(0,0,0,0.1) 0px,transparent 1px,transparent 55px,rgba(0,0,0,0.07) 55px)",
          }}/>

          {/* Books */}
          <div style={{ display: "flex", alignItems: "flex-end", gap: "5px", height: "100%", paddingBottom: "20px" }}>
            {books.map((b, i) => {
              const isH = hov === i;
              ...
              return (
                <div
                  ...
                  style={{
                    flex: 1,
                    height: `${215 + offsets[i]}px`,
                    position: "relative",
                    transform: isH ? "translateY(-28px) scale(1.04)" : "translateY(0) scale(1)",
                    transition: "transform 0.45s cubic-bezier(0.34,1.56,0.64,1)",
                    filter: isH
                      ? "drop-shadow(0 30px 40px rgba(0,0,0,0.9)) drop-shadow(0 0 30px rgba(201,160,96,0.3))"
                ...
                >
                  ...
                  <div style={{
                    ...
                    background: `linear-gradient(90deg,
                      #04060a 0%, #080d18 6%, #0d1525 14%, #121d35 24%,
                      #1a2645 34%, #1e2d52 44%, #1a2645 54%, #121d35 64%,
                      #0d1525 76%, #080d18 88%, #04060a 100%)`,
                    borderRadius: "4px 2px 2px 4px",
                    border: isH ? "1px solid rgba(180,130,60,0.6)" : "1px solid rgba(201,160,96,0.14)",
                    borderLeft: isH ? "1.5px solid rgba(201,150,50,0.7)" : "1.5px solid rgba(201,160,96,0.09)",
                    position: "relative", overflow: "hidden",
                    transition: "border 0.3s",
                  }}>
                    {/* Cylinder highlight */}
                    <div style={{
                      position: "absolute", top: 0, bottom: 0, left: "28%", width: "44%",
                      background: "linear-gradient(90deg,transparent 0%,rgba(255,255,255,0.03) 30%,rgba(255,255,255,0.055) 50%,rgba(255,255,255,0.03) 70%,transparent 100%)",
                    }}/>
                    {/* Left shadow */}
                    ...
                    <div style={{
                      ...
                      backgroundImage: "repeating-linear-gradient(180deg,transparent,transparent 5px,rgba(0,0,0,0.1) 5px,rgba(0,0,0,0.1) 6px)",
                    }}/>
                    {/* Double inner border */}
                    ...
                    {[[true,false],[true,true],[false,false],[false,true]].map(([top, left], ci) => (
                      <div key={ci} style={{
                        position: "absolute",
                        top: top ? "11px" : undefined, bottom: top ? undefined : "11px",
                        left: left ? undefined : "8px", right: left ? "8px" : undefined,
                        width: "7px", height: "7px",
                        borderTop: top ? "1px solid rgba(201,160,96,0.45)" : undefined,
                        borderBottom: !top ? "1px solid rgba(201,160,96,0.45)" : undefined,
                        borderLeft: !left ? "1px solid rgba(201,160,96,0.45)" : undefined,
                        borderRight: left ? "1px solid rgba(201,160,96,0.45)" : undefined,
                      }}/>
                    ))}

                    {/* Content */}
                    <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", padding: "16px 5px" }}>
                      {/* Chapter */}
                      ...
                      {/* Icon */}
                      <div style={{ fontSize: "18px", filter: isH ? "drop-shadow(0 0 6px rgba(201,160,96,0.7))" : "none", transition: "filter 0.3s" }}>{b.icon}</div>
                      ...
                      {/* Title */}
                      <div style={{ textAlign: "center" }}>
                        <div style={{ fontSize: "6px", fontWeight: 700, color: isH ? "#D4B070" : C.gold, fontFamily: "Georgia,serif", lineHeight: 1.3, transition: "color 0.3s", textShadow: isH ? "0 0 10px rgba(201,160,96,0.6)" : "none" }}>{b.title}</div>
                    ...
                    {/* Ribbon bookmark on hover */}
                    <div style={{
                      position: "absolute", top: "-1px", left: "50%", transform: "translateX(-50%)",
                      width: "10px",
                      height: isH ? "18px" : "0px",
                      background: "linear-gradient(180deg,#C9A060,#8B6020)",
          ...
          {/* Shelf plank */}
          <div style={{
            position: "absolute", bottom: "0", left: "6px", right: "6px", height: "14px",
            background: "linear-gradient(180deg,#8B5E2A,#4A2E08)",
            borderRadius: "1px",
            boxShadow: "0 4px 16px rgba(0,0,0,0.7), inset 0 1px 0 rgba(201,160,96,0.15)",
          }}/>
        </div>
      </div>
    </div>
...
function PhoneContent({ screenIdx }: { screenIdx: number }) {
  const screens = [
    // Dashboard mobile
    <div key="dash" style={{ padding: "7px", display: "flex", flexDirection: "column", gap: "5px" }}>
      ...
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: "5px", padding: "5px" }}>
        ...
        <svg width="100%" height="36" viewBox="0 0 120 36" preserveAspectRatio="none">
          <defs><linearGradient id="pm1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#C9A060" stopOpacity="0.35"/><stop offset="100%" stopColor="#C9A060" stopOpacity="0"/></linearGradient></defs>
          <path d="M0,30 L17,22 L34,26 L51,10 L68,16 L85,12 L102,18 L120,14 L120,36 L0,36Z" fill="url(#pm1)"/>
    ...
    // Gerador mobile
    <div key="ger" style={{ padding: "7px", display: "flex", flexDirection: "column", gap: "5px" }}>
      <div style={{ fontSize: "7px", fontWeight: 700, color: C.champ, fontFamily: "Georgia,serif" }}>Gerador</div>
      <div style={{ background: C.card, border: "1px solid rgba(201,160,96,0.25)", borderRadius: "5px", padding: "5px", fontSize: "5px", color: "rgba(255,255,255,0.65)", lineHeight: 1.6 }}>
        &ldquo;Quanto custa o botox? Vi no Instagram ✨&rdquo;
      </div>
      {[
        { l: "Suave 🌸",      c: C.blue,   t: "Oi! Que bom que nos encontrou..." },
        { l: "Consultiva 💎", c: C.gold,   t: "Antes de falar em valor, me conta..." },
        { l: "Fechamento 🎯", c: C.green,  t: "Tenho horário essa semana — quando?" },
      ].map(r => (
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "7px" }}>
        <div style={{ position: "relative", width: "56px", height: "56px", flexShrink: 0 }}>
          <svg width="56" height="56" viewBox="0 0 100 100">
            ...
            <circle cx="50" cy="50" r="44" fill="none" stroke={C.orange} strokeWidth="8" strokeLinecap="round"
    ...
    // Objeções mobile — mini bookshelf
    <div key="obj" style={{ padding: "7px", display: "flex", flexDirection: "column", gap: "5px", height: "100%" }}>
      <div style={{ fontSize: "7px", fontWeight: 700, color: C.champ, fontFamily: "Georgia,serif" }}>Objeções</div>
      <div style={{ flex: 1, background: "radial-gradient(ellipse at 50% 0%,#3d2a12,#0e0903)", borderRadius: "7px", padding: "14px 8px 0", position: "relative", display: "flex", flexDirection: "column", justifyContent: "flex-end", overflow: "hidden", minHeight: "100px" }}>
        ...
        <div style={{ display: "flex", gap: "3px", alignItems: "flex-end", paddingBottom: "16px" }}>
          {[
            { t: "Preço", h: 78 }, { t: "Medo", h: 82 }, { t: "Confiança", h: 75 },
            { t: "Agenda.", h: 80 }, { t: "Pós-venda", h: 77 },
          ].map((b, i) => (
            <div key={b.t} style={{
              flex: 1,
              height: `${b.h}px`,
              ...
              borderLeft: "1.5px solid rgba(201,160,96,0.08)",
              ...
              <div style={{ fontSize: "5px", fontWeight: 700, color: C.gold, fontFamily: "Georgia,serif", marginTop: "2px" }}>{String(i+1).padStart(2,"0")}</div>
              <span style={{ position: "absolute", bottom: "18px", fontSize: "3.5px", color: "rgba(201,160,96,0.65)", writingMode: "vertical-rl", transform: "rotate(180deg)", fontWeight: 600 }}>{b.t}</span>
            </div>
          ))}
        </div>
        <div style={{ position: "absolute", bottom: 0, left: "4px", right: "4px", height: "10px", background: "linear-gradient(180deg,#8B5E2A,#4A2E08)", borderRadius: "1px", boxShadow: "0 3px 10px rgba(0,0,0,0.7)" }}/>
      </div>
    </div>,
  ];
...
export function HeroDevices() {
  ...
  const phoneEnter: React.CSSProperties = {
    ...
    opacity: visible ? 1 : 0,
    transform: visible ? "translateY(0) rotate(4deg)" : "translateY(90px) rotate(4deg)",
  };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "14px", width: "100%" }}>
      ...
      <div style={{ display: "flex", gap: "6px", flexWrap: "wrap", justifyContent: "center" }}>
        {SCREENS.map((s, i) => (
          <button
            ...
            onClick={() => switchTo(i)}
            style={{
              background: i === active ? C.gold : "rgba(255,255,255,0.06)",
      ...
      {/* Device wrapper */}
      <div style={{ position: "relative", display: "flex", justifyContent: "flex-start", alignItems: "flex-end", width: "100%", minHeight: "430px" }}>
        ...
        <div style={{ ...laptopEnter, position: "relative", zIndex: 10 }}>
          ...
          <div style={{
            ...
            <div style={{ position: "absolute", inset: "16px 14px 10px", background: C.bg, borderRadius: "6px", overflow: "hidden" }}>
              {/* OS window chrome */}
              <div style={{
                height: "18px", background: "#030810",
                borderBottom: `1px solid ${C.border}`,
                display: "flex", alignItems: "center",
                paddingLeft: "10px", paddingRight: "10px", gap: "5px",
              }}>
          ...
          <div style={{
            ...
            background: "linear-gradient(180deg,#111e2d,#0a1520)",
            borderRadius: "0 0 8px 8px",
            border: "2px solid #162030", borderTop: "none",
            display: "flex", alignItems: "center", justifyContent: "center",
          }}>
        ...
        <div style={{
          ...
          <div style={{
            width: "162px", height: "310px",
            background: "#060d1a",
            borderRadius: "26px",
            border: "2.5px solid #162030",
            position: "relative", overflow: "hidden",
            boxShadow: "8px 14px 50px rgba(0,0,0,0.85), 0 0 0 1px rgba(201,160,96,0.07)",
          }}>
            {/* Dynamic island */}
