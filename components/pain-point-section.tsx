...
// ─── AnimatedCounter ──────────────────────────────────────────────────────────
function AnimatedCounter({ target, prefix = "", duration = 900 }: { target: number; prefix?: string; duration?: number }) {
...
function ConversationBubbles() {
  return (
    <div style={{ pointerEvents: "none" }}>
        ...
        <div style={{ display: "flex", gap: "4px", alignItems: "center", justifyContent: "center" }}>
          {[0, 0.15, 0.3].map((delay, i) => (
            <motion.div
              key={i}
              animate={{ y: [0, -4, 0] }}
              transition={{ duration: 0.8, delay, repeat: Infinity, repeatDelay: 1.5, ease: "easeInOut" }}
              style={{ width: 6, height: 6, borderRadius: "50%", background: "#C9A060", opacity: 0.7 }}
            />
          ))}
        </div>
      </motion.div>
      ...
      >
        {[100, 70, 85].map((w, i) => (
          <div key={i} style={{ height: 6, borderRadius: 9999, background: "#E8E4DC", width: `${w}%` }} />
        ))}
      </motion.div>
      ...
      >
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
          <path d="M2 2l8 8M10 2l-8 8" stroke="#ef4444" strokeWidth="1.8" strokeLinecap="round" />
        </svg>
      </motion.div>
    </div>
  );
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        <div style={{
          ...
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M12 7v1m0 8v1M9.5 9.5C9.5 8.4 10.6 8 12 8s2.5.9 2.5 2c0 1.5-2.5 2-2.5 3.5M12 16h.01" stroke="#C9A060" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        </div>
        <div>
          <p style={{ fontSize: "12px", color: "#6b7280", margin: "0 0 4px", lineHeight: 1.4 }}>
            Cada conversa que some pode valer de
          </p>
          <p style={{ fontSize: "15px", fontWeight: 800, color: "#C9A060", margin: 0 }}>
            <AnimatedCounter target={800} prefix="R$" duration={800} /> a <AnimatedCounter target={3000} prefix="R$" duration={900} />
          </p>
        </div>
      </div>
    </motion.div>
...
function LeakingFunnelCard() {
  return (
    ...
    >
      <p style={{ fontSize: "10px", fontWeight: 700, color: "#C9A060", letterSpacing: "0.08em", textTransform: "uppercase", margin: "0 0 16px", textAlign: "center" }}>
        Vendas que vazam<br />antes de acontecer
      </p>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
          ...
          {[0, 0.1, 0.2, 0.3].map((delay, i) => (
            ...
            >
              <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                <circle cx="5" cy="5" r="3" stroke="#C9A060" strokeWidth="1.2" />
                <line x1="5" y1="2.5" x2="5" y2="3.5" stroke="#C9A060" strokeWidth="1" strokeLinecap="round" />
              </svg>
            </motion.div>
          ))}
        </div>
        ...
        <svg width="100" height="70" viewBox="0 0 100 70" fill="none">
          <path d="M10 5 L90 5 L62 45 L38 45 Z" stroke="#C9A060" strokeWidth="1.5" fill="rgba(201,160,96,0.06)" strokeLinejoin="round" />
          <line x1="50" y1="45" x2="50" y2="65" stroke="#C9A060" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="3 3" />
          {/* Leaking dots */}
          <motion.circle
            cx="22" cy="28"
            r="4"
            ...
            transition={{ duration: 2, delay: 0.5, repeat: Infinity, repeatDelay: 4, ease: "easeOut" }}
          />
          <motion.circle
            cx="78" cy="28"
            r="4"
            ...
            strokeWidth="1"
            animate={{ x: [5, 12], opacity: [0.8, 0], y: [0, 8] }}
            transition={{ duration: 2, delay: 1, repeat: Infinity, repeatDelay: 4, ease: "easeOut" }}
          />
        </svg>
        ...
        <div style={{ display: "flex", gap: "8px", justifyContent: "center", marginTop: "-4px" }}>
          {[0.2, 0.4, 0.6].map((delay, i) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 0.3, delay: 0.8 + delay, type: "spring", stiffness: 300 }}
              style={{
          ...
          return (
            ...
            >
              <button
                ...
                style={{
                  width: "100%",
                  background: isChecked ? "rgba(201,160,96,0.06)" : "transparent",
                  border: "none",
                  borderRadius: "10px",
                  padding: "13px 10px",
                  cursor: "pointer",
                ...
                onMouseEnter={(e) => {
                  if (!isChecked) (e.currentTarget as HTMLButtonElement).style.background = "rgba(239,68,68,0.04)";
                }}
                onMouseLeave={(e) => {
              ...
              >
                ...
                >
                  {isChecked ? (
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                      <path d="M2 5l2.5 2.5 4-4" stroke="#C9A060" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  ) : (
              ...
              {i < CHECKLIST.length - 1 && (
                <motion.div
                  ...
                  style={{ height: "1px", background: "#F3F0EA", margin: "0 10px" }}
                />
              )}
            </motion.div>
          );
      ...
      <AnimatePresence>
        {showMessage && (
          ...
          >
            ...
            <p style={{ fontSize: "13px", color: "#92610A", fontWeight: 600, margin: 0, lineHeight: 1.5 }}>
    ...
    >
      ...
      >
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
          ...
          <circle cx="17" cy="17" r="9" stroke="#C9A060" strokeWidth="1.5" opacity="0.5" />
          <circle cx="17" cy="17" r="4" fill="#C9A060" opacity="0.8" />
          <line x1="17" y1="3" x2="17" y2="6" stroke="#C9A060" strokeWidth="1.5" strokeLinecap="round" />
          <line x1="17" y1="28" x2="17" y2="31" stroke="#C9A060" strokeWidth="1.5" strokeLinecap="round" />
          <line x1="3" y1="17" x2="6" y2="17" stroke="#C9A060" strokeWidth="1.5" strokeLinecap="round" />
          <line x1="28" y1="17" x2="31" y2="17" stroke="#C9A060" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
      </motion.div>
      ...
      <div>
        <motion.p
          ...
          style={{ fontSize: "17px", color: "rgba(255,255,255,0.9)", fontWeight: 600, margin: "0 0 6px", lineHeight: 1.4 }}
        >
      ...
      >
        ...
        >
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            <circle cx="9" cy="9" r="4" stroke="#C9A060" strokeWidth="1.3" opacity="0.5" />
...
export function PainPointSection({ funilHref = "/signup" }: { funilHref?: string }) {
  return (
    <section
      id="problema"
      style={{ background: "#F5F0E6", padding: "100px 24px", overflow: "hidden" }}
    >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "160px 1fr 160px", gap: "24px", marginBottom: "64px", alignItems: "start" }} className="header-grid">
          ...
          >
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
              <circle cx="6.5" cy="6.5" r="5.5" stroke="#92610A" strokeWidth="1.2" />
              <path d="M6.5 4v3.5" stroke="#92610A" strokeWidth="1.2" strokeLinecap="round" />
      ...
      {/* Mobile value card */}
      <div className="lg:hidden" style={{ maxWidth: "980px", margin: "24px auto 0", padding: "0" }}>
        <div style={{
          background: "#ffffff",
          border: "1px solid #E8E4DC",
          borderRadius: "16px",
