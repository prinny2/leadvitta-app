  ...
  return (
    <div className="space-y-4">
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="lg:col-span-2 h-[248px] animate-pulse rounded-2xl border border-navy-500 bg-navy-700/70 shadow-card" />
        <div className="h-[248px] animate-pulse rounded-2xl border border-navy-500 bg-navy-700/70 shadow-card" />
      </div>
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="h-[232px] animate-pulse rounded-2xl border border-navy-500 bg-navy-700/70 shadow-card" />
        <div className="h-[232px] animate-pulse rounded-2xl border border-navy-500 bg-navy-700/70 shadow-card" />
      </div>
      <div className="h-[170px] animate-pulse rounded-2xl border border-navy-500 bg-navy-700/70 shadow-card" />
    </div>
  );
}
