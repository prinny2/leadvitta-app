...
import { Sparkles, Flame, TrendingUp, ChevronRight,
...
// dashboard shell, greeting, and module grid become interactive immediately.
const DashboardCharts = dynamic(() => import("./charts"), {
  ssr: false,
  loading: () => (
    <div className="grid gap-4">
      <div className="h-48 rounded-2xl border border-navy-500 bg-navy-700 animate-pulse" />
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="h-44 rounded-2xl border border-navy-500 bg-navy-700 animate-pulse" />
        <div className="h-44 rounded-2xl border border-navy-500 bg-navy-700 animate-pulse" />
      </div>
    </div>
  ),
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* ── Gráficos — carregados de forma assíncrona para não bloquear o shell ── */}
      <DashboardCharts />
