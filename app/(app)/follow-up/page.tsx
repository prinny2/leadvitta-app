    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-sm text-navy-100 mt-1">
          Reative quem sumiu depois de perguntar ou agendar — sem parecer
          insistente. São 3 mensagens escalonadas no ritmo certo.
        </p>
      </div>
          ...
          {!loading && !mensagens && (
            <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-navy-500 bg-navy-700 py-14 text-center">
              ...
              <p className="text-sm font-medium text-champagne-300 mb-1">
                Sequência aparece aqui
              </p>
              <p className="text-xs text-navy-100 max-w-[220px] leading-relaxed">
                Escolha o tempo e o contexto ao lado para gerar 3 mensagens
                escalonadas.
              </p>
